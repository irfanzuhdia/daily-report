...
export default async function ProjectDetailPage({
  ...
  const [project, tasks, statuses, allReports, allUsers] = await Promise.all([
  ...
  const createdByName = userMap[project.created_by ?? ""] ?? project.created_by ?? "—"
  const updatedByName = userMap[project.updated_by ?? ""] ?? project.updated_by ?? "—"
