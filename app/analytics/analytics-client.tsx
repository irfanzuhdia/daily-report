...
export function ContributionCalendar({
  ...
  const [viewMode, setViewMode] = useState<"all" | "project" | "personal">("all")
            ...
            <div className="w-full sm:w-auto">
              ...
              <Select value={viewMode} onValueChange={(v) => setViewMode(v as "all" | "project" | "personal")}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="personal">My Contributions</SelectItem>
            ...
            {viewMode === "personal" && (
              <div className="w-full sm:w-auto">
                ...
                <Select value={selectedUser} onValueChange={setSelectedUser}>
                  ...
                  <SelectContent>
                    {users.map((u) => (
                      <SelectItem key={u.user_id} value={u.user_email}>
